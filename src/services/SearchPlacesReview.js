...
// const SERPAPI_KEY = "s2YtGJsuNJv9eccEvfWhGAfP"; // ใส่ API Key ของคุณ
...
//         const response = await axios.get("https://www.searchapi.io/api/v1/search?api_key=fM2RTmgMGPMiZyqjWubMj7Kz&engine=google_maps_reviews&place_id=ChIJhRwB-yFawokR5Phil-QQ3zM", {
//           params: {
//             engine: "google_maps",
//             q: keyword,
//             location: "ประเทศไทย",
